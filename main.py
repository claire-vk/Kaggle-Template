'''
The goal of this script is to automate a few steps of the machine learning process, in particular 
the steps when we explore, clean and transform the data. 
'''
...
class Explore:
    ...
    # get types of each column and classify them as numeric, nominal and categorical
    ...
    # identify features that are skewed to scale them in the cleaning process
    ...
    # visualize distribution of the variables
...
class Clean:
    ...
    # encode nominal and categorical features
    ...
    # drop columns that user wants to ignore
    ...
    # automatically drop features not correlated with target variable
...
# The engineering part can't be fully automated as it requires some knowledge about the dataset
